...
export function DS44() {
    return (
        <section id="ds44" className="py-16 md:py-24 border-t border-white/10 bg-black-light">
                ...
                <div className="grid gap-10 lg:grid-cols-5 lg:gap-16">
                    <div className="lg:col-span-2">
                        ...
                        <RevealWrapper delay={0.1} className="mt-6">
                            <p className="text-sm md:text-base text-gray leading-relaxed">{DS44_DATA.context}</p>
                            ...
                            {DS44_DATA.steps.map((step, i) => (
                                <RevealWrapper key={step.n} delay={i * 0.05}>
                                    <li className="card h-full p-5">
                                        <span className="font-mono text-sm font-bold text-gold">{step.n}</span>
                                        <h3 className="mt-2 text-base font-semibold text-white">{step.title}</h3>
                                        <p className="mt-1 text-sm text-gray leading-relaxed">{step.desc}</p>
                                    </li>
                                </RevealWrapper>
                            ))}
                        </ol>
