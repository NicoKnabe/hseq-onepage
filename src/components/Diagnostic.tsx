...
export function Diagnostic() {
    return (
        <section id="diagnostico" className="py-16 md:py-24 border-t border-line">
            <div className="container mx-auto px-4 md:px-6">
                <RevealWrapper className="rounded-2xl border border-accent/50 bg-gradient-to-br from-surface to-white p-6 md:p-10 lg:p-14">
                    <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-start">
                        ...
                        <div>
                            <p className="text-sm font-semibold uppercase tracking-widest text-ink/70 mb-4">Qué incluye</p>
                            <ul className="grid gap-3 sm:grid-cols-2">
                                {DIAGNOSTIC_DATA.includes.map((item) => (
                                    <li key={item} className="flex items-start gap-3 rounded-lg border border-line bg-white/80 px-4 py-3">
