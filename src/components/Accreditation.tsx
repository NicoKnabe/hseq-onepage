...
export function Accreditation() {
    return (
        <section id="acreditacion" className="py-16 md:py-24 border-t border-white/10">
                ...
                <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
                    <div>
                        ...
                        <RevealWrapper delay={0.1}>
                            <p className="mt-6 text-sm text-gray leading-relaxed">
                        ...
                        <ul className="grid gap-3 sm:grid-cols-2">
                            {ACCREDITATION_DATA.items.map((item) => (
                                <li key={item} className="card flex items-center gap-3 px-4 py-3.5">
                                    <FileCheck2 className="w-5 h-5 shrink-0 text-gold" aria-hidden="true" />
                                    <span className="text-sm font-medium text-white-dim">{item}</span>
                                </li>
                            ))}
                        </ul>
                    </RevealWrapper>
